    ...
    >
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>{t(lang, 'signIn')}</Text>
          ...
          >
            {loading
              ? <Text style={styles.btnText}>{t(lang, 'signingIn')}</Text>
              : (
                <View style={styles.btnInner}>
                  <Ionicons name="log-in-outline" size={18} color="#fff" />
                  <Text style={styles.btnText}>{t(lang, 'signIn')}</Text>
                </View>
              )
            }
          </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => router.push('/(auth)/register')} style={styles.switchWrap}>
          <Text style={styles.switchText}>
            ...
            <Text style={styles.switchLink}>{t(lang, 'register')}</Text>
          </Text>
        </TouchableOpacity>
      </ScrollView>
    </KeyboardAvoidingView>
